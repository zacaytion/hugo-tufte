...
But tight integration of graphics {{< figure
  ...
  alt="alt"
  link="link"
>}} with text is central to Tufte’s work even when those graphics are ancillary to the main body of a text. In many of those cases, a margin figure may be most appropriate.
